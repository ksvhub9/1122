    ...
    <>
      <div className="container contact-page">
        <div className="text-zone">
          ...
          <p>Contact Number: 8179840530
Email: kumarsaivaibhav4@gmail.com</p>
        ...
        <div className="map-wrap">
          ...
          <MapContainer center={[17.5295894, 80.633551]} zoom={13}>
            <TileLayer
              url="https://api.maptiler.com/maps/streets/{z}/{x}/{y}.png?key=bZADdJM7PbEfkm7iO9k3"
